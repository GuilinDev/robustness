...
if [ "$TEST_MODE" = true ]; then
    ...
    RESULTS_FILE="experiments/results/deep_lift_robustness_results.json"
    TEMP_FILE="experiments/results/deep_lift_temp.json"
    VIZ_DIR="experiments/results/deep_lift_viz"
