#!/bin/bash
# LIME本地测试脚本 - 用于验证设置并在少量图像上测试

# 设置路径和文件名
TEST_DIR="experiments/test_data/tiny-imagenet-200/val/n01443537"
RESULTS_FILE="experiments/results/lime_local_test_results.json"
TEMP_FILE="experiments/results/lime_local_temp.json"
VIZ_DIR="experiments/results/lime_viz_local_test"
FIGURES_DIR="experiments/results/figures/lime_local_test"
REPORT_PATH="experiments/results/lime_local_test_analysis_report.md"
...
# 执行LIME鲁棒性测试
echo "开始执行LIME鲁棒性测试..."
python experiments/scripts/lime/test_lime_robustness.py \
    --image_dir "$TEST_DIR" \
