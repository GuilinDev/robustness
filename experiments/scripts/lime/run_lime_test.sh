...
if [ "$TEST_MODE" = true ]; then
    ...
    RESULTS_FILE="experiments/results/lime_robustness_results.json"
    TEMP_FILE="experiments/results/lime_temp.json"
    VIZ_DIR="experiments/results/lime_viz"
...
if [ "$OPTIMIZE" = true ]; then
    ...
    echo "已将LIME nsamples设置为 $STEPS (原默认值: 1000)"
